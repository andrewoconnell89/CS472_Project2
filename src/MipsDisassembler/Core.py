...
class Disassembler(object):
	...
	#I was building this to convert the decimal numbers
	#of registers to the s/t that was explained in the book
	#my interpertation is that we aren't susposed to do this
	#since the beq example isn't using it
	##KEEPING FOR FUTURE PROJECT
	REGISTER = { 8 : 't0',
		9  : 't1',
		10 : 't2',
		11 : 't3',
